 ...
 * </pre></blockquote>
 */
public class MDSMicrometerMetricsTracker implements IMetricsTracker {
    /**
    ...
    private static final String METRIC_USERNAME = "username";
    private static final String METRIC_JDBCURL = "jdbcurl";
    private static final String METRIC_HOST = "host";
    private static final String METRIC_PORT = "port";
    private static final String METRIC_DB = "db";
//    private static final String METRIC_MDS_NAME = "mdsname";
    private static final String METRIC_MDS_VERSION = "mdsversion";
    ...
    MDSMicrometerMetricsTracker(final String poolName, final PoolStats poolStats, final MeterRegistry meterRegistry, final String userName, final String jdbcUrl, String host, String port, String db, String mdsName, String mdsVersion) {
        ...
        this.connectionObtainTimer = Timer.builder(METRIC_NAME_WAIT)
                ...
                .tags(METRIC_USERNAME, userName)
                .tags(METRIC_JDBCURL, jdbcUrl)
                .tags(METRIC_HOST, host)
                .tags(METRIC_PORT, port)
                .tags(METRIC_DB, db)
//                .tags(METRIC_MDS_NAME, mdsName)
                .tags(METRIC_MDS_VERSION, mdsVersion)
